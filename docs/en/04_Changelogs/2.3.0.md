 ...
 * ![rev:68752] Fixed TranslatableTest to instantiate Page instead of SiteTree fixtures - pages in the database should never have ClassName=SiteTree. This was causing failing tests due to the changes in SiteTree->getClassDropdown()
 ...
 * ![rev:68155] Added stub PDODatabase->renameField() implementation to avoid errors when batch-instantiating singletons
 ...
 * ![rev:66505] Consistenly returning cloned instances for all FormField classes when calling performReadonlyTransformation() or performDisabledTransformation(). Making sure that these instances are actually flagged as readyonly/disabled. Addd unit tests to dynamically instantiate most FormField classes to check for this behaviour. Originally, this bugfix was necessary to avoid changed FormField state when recursively calling replaceField() on FieldSet->dataFields() in Translatable->updateCMSFields()
 ...
 * ![rev:65062] Dont instantiate abstract classes in i18nTextCollector
 ...
 * ![rev:65030] Different class_implements() usage without instantiating the class in i18nTextCollector - not all classes are instantiatable without arguments. This raises the minimum requirement for text collection to PHP 5.1+
 ...
 * ![rev:60757] Fixed TableListField->Link() to allow for instantiation without a form/controller (e.g. for unit tests)
