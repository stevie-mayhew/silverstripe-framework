...
All emails going out of our application will have the footer `Thanks from Bob's Fantasy Football League` added.
...
instance. This is a serialised object containing a map of template names, paths and other meta data for each template 
...
It will each and prioritise templates in the following priority:
